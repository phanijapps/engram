...
- `.codex/hooks/check-docs.sh`: rejects unresolved placeholder markers in docs and skills, validates local Codex skills, then runs code documentation and TypeScript native-delegation checks.
