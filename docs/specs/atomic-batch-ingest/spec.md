...
- [ ] v1 reports `Skipped` for the Evidence and Embeddings steps (evidence is embedded in record provenance; embeddings need VectorIndex wiring). (deferred: `atomic-batch-evidence-embeddings`)
